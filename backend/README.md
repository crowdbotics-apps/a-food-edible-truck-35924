...
## Project Structure
    ...
    ├── a_food_edible_truck_35924  # Django project configurations
...
1. Clone this repo and `cd a_food_edible_truck_35924`
...
2. Clone this repo and `cd a_food_edible_truck_35924`
